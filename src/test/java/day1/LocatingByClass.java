...
public class LocatingByClass {
    ...
    public void test1(){
        ...
        try {
            ...
            // classname are normally not unique, this method is usually used to locate multiple elements that match the criteria
            // findElement returns the first element that matches the first criteria
            driver.findElement(By.className("yuRUbf")).getText();
